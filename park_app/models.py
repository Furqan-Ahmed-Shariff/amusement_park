...
class Worker(models.Model):
    Name = models.CharField(max_length=20)
    StallID = models.ForeignKey(Stall, on_delete=models.CASCADE, related_name = "workers", blank=True)
    RideID = models.ForeignKey(Ride, on_delete=models.CASCADE, related_name="controllers", blank=True)
